...
public class Restaurant : IRestaurant
{
    ...
    public async Task RequestBookingTableEventBySmsAsync(int countOfPersons, CancellationToken cancellationToken)
    {
    ...
    /// <param name="countOfPersons">Количество человек</param>
    /// <param name="cancellationToken">Токен отмены</param>
    public async Task RequestBookingTableEventByPhoneAsync(int countOfPersons, CancellationToken cancellationToken)
    {
        DateTime dateTime = DateTime.Now;
        await _bus.Publish<IBookingRequestEvent>(new BookingRequestEvent(
            Guid.NewGuid(),
