...
public interface IRestaurant
{
    ...
    Task RequestBookingTableEventBySmsAsync(int countOfPersons, CancellationToken cancellationToken);
    Task RequestBookingTableEventByPhoneAsync(int countOfPersons, CancellationToken cancellationToken);
